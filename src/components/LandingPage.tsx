...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        animate={reduce ? undefined : { scale: [1.2, 1, 1.2], opacity: [0.1, 0.2, 0.1], rotate: [0, -90, 0] }}
        transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
        style={{
          position: "absolute", bottom: "-10%", left: "-10%", width: "50vw", height: "50vw",
          borderRadius: "50%", background: "radial-gradient(circle, var(--neon-purple-glow) 0%, transparent 70%)",
      ...
      <motion.div
        ...
        style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "800px", width: "100%", minWidth: 0 }}
      >

...
const MEAL_TEMPLATES: Record<string, MealTemplate[]> = {
  ...
  high_protein: [
    { time: "7:00 AM",  name: "Protein-Packed Breakfast",  description: "6-egg white omelette with 2 whole eggs, turkey breast strips, feta, spinach; protein shake on the side",  calShare: 0.24, protShare: 0.30, carbShare: 0.14, fatShare: 0.20 },
    { time: "10:00 AM", name: "Cottage Cheese Bowl",       description: "Low-fat cottage cheese with pineapple chunks, flaxseeds, and a sprinkle of cinnamon",                       calShare: 0.12, protShare: 0.16, carbShare: 0.10, fatShare: 0.08 },
    { time: "1:00 PM",  name: "Double Protein Lunch",      description: "Tuna salad over mixed greens with boiled eggs, chickpeas, olive oil, and lemon dressing",                   calShare: 0.26, protShare: 0.28, carbShare: 0.20, fatShare: 0.24 },
    { time: "4:30 PM",  name: "Whey + Rice Cakes",         description: "Whey protein shake (1 scoop) blended with milk, 3 rice cakes with almond butter",                          calShare: 0.14, protShare: 0.18, carbShare: 0.16, fatShare: 0.12 },
    { time: "7:30 PM",  name: "Lean Meat Dinner",          description: "Grilled turkey tenderloin or lean beef, quinoa, roasted asparagus, cottage cheese side",                    calShare: 0.24, protShare: 0.08, carbShare: 0.40, fatShare: 0.36 },
  ],
  low_carb: [
    { time: "8:00 AM",  name: "Keto Breakfast",       description: "Bulletproof coffee, 3-egg omelette with bacon, cheese, and spinach, half an avocado",                       calShare: 0.26, protShare: 0.22, carbShare: 0.06, fatShare: 0.34 },
    { time: "11:00 AM", name: "Cheese & Nut Snack",   description: "Hard cheese cubes, macadamia or Brazil nuts, a few olives",                                                  calShare: 0.12, protShare: 0.08, carbShare: 0.04, fatShare: 0.18 },
    { time: "1:30 PM",  name: "Low-Carb Power Bowl",  description: "Grilled chicken thighs over cauliflower rice with roasted peppers, feta, and tahini drizzle",               calShare: 0.28, protShare: 0.30, carbShare: 0.12, fatShare: 0.26 },
    { time: "4:30 PM",  name: "Avocado Protein Snack",description: "½ avocado stuffed with canned salmon or tuna, lemon juice, red onion, capers",                               calShare: 0.10, protShare: 0.12, carbShare: 0.04, fatShare: 0.12 },
    { time: "7:30 PM",  name: "Fatty Fish Dinner",    description: "Pan-seared salmon or mackerel, zucchini noodles with pesto, side of sautéed mushrooms in butter",           calShare: 0.24, protShare: 0.28, carbShare: 0.74, fatShare: 0.10 },
  ],
  vegetarian: [

...
import { Scale, TrendingUp, Moon, Droplets, Target, Dumbbell } from "lucide-react";
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="page active">
      ...
      <div className="auto-grid">
        {tips.map((tip, i) => (
          ...
          >
            <div className="icon-tile" style={{ "--tile-size": "52px", "--tile-color": tip.color } as React.CSSProperties}>
              {tip.icon}
            </div>
